...
class Summarie extends DataClass implements Insertable<Summarie> {
  final int id;
  final int year;
  ...
  factory Summarie.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return Summarie(
      id: const IntType()
          .mapFromDatabaseResponse(data['${effectivePrefix}id'])!,
  ...
  factory Summarie.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return Summarie(
      id: serializer.fromJson<int>(json['id']),
  ...
  Summarie copyWith(
          {int? id, int? year, String? content, DateTime? dateCreated}) =>
      Summarie(
        id: id ?? this.id,
        year: year ?? this.year,
  ...
  @override
  int get hashCode => Object.hash(id, year, content, dateCreated);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Summarie &&
...
class SummariesCompanion extends UpdateCompanion<Summarie> {
  final Value<int> id;
  final Value<int> year;
  ...
  SummariesCompanion.insert({
    ...
    required DateTime dateCreated,
        ...
        content = Value(content),
        dateCreated = Value(dateCreated);
  static Insertable<Summarie> custom({
    Expression<int>? id,
    Expression<int>? year,
...
class $SummariesTable extends Summaries
    with TableInfo<$SummariesTable, Summarie> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<DateTime?> dateCreated =
      GeneratedColumn<DateTime?>('date_created', aliasedName, false,
          type: const IntType(), requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, year, content, dateCreated];
  @override
  String get aliasedName => _alias ?? 'summaries';
  @override
  String get actualTableName => 'summaries';
  @override
  VerificationContext validateIntegrity(Insertable<Summarie> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Summarie map(Map<String, dynamic> data, {String? tablePrefix}) {
    return Summarie.fromData(data,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
